...
function load_tema_script() {
   ...
   if ( !is_admin() ) {
       ...
       wp_enqueue_script( 'meutema_bootstrap_js', CORE_BOOTSTRAP_JS . 'bootstrap.min.js', array( 'jquery' ), '', true );
        wp_enqueue_script( 'meutema_isotope_js', CORE_ISOTOPE_JS . 'isotope.pkgd.min.js', array( 'jquery' ), '', true );
       // JS do tema
...
define( 'CORE_ISOTOPE_JS',  get_template_directory_uri() . '/assets/bower_components/isotope/dist/'  );
